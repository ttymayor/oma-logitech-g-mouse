        ...
        Column {
          ...
          Rectangle {
            ...
            Row {
              ...
              Text {
                anchors.verticalCenter: parent.verticalCenter
                text: root.mouseConnected
                  ? Model.batteryIcon(root.batteryPercentage, root.batteryStatus)
                  : "󰍽"
                color: root.foreground
              ...
              Column {
                ...
                Text {
                  text: root.mouseConnected
                    ? "Battery: " + Model.batteryText(root.batteryPercentage) + " (" + root.batteryStatus + ")"
                    : "Disconnected"
                  color: root.foreground
                  font.family: root.fontFamily
                ...
                Text {
                  text: root.mouseConnected
                    ? "DPI: " + Model.dpiText(root.dpiX, root.dpiY) + " · LOD: " + Model.lodLabel(root.lod) + " · " + root.reportRate + "Hz"
          ...
          Row {
            ...
            Repeater {
              model: [
                { id: "sensor",  label: "Sensor (DPI / Polling)" },
                { id: "buttons", label: "Buttons (Analog HITS)" }
              ]
              delegate: Rectangle {
                  ...
                  delegate: Rectangle {
                    ...
                    MouseArea {
                      ...
                      onClicked: {
                        ...
                        if (root.mouse) root.mouse.setDpi(modelData)
                      }
                    }
                  }
                }
              ...
              Column {
                ...
                PanelSlider {
                  ...
                  onReleased: function(val) {
                    ...
                    if (root.mouse) root.mouse.setDpi(target)
                  }
                }
              ...
              Row {
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    radius: 4
                    color: (root.mouse && root.mouse.reportRate === modelData)
                      ? Qt.rgba(root.foreground.r, root.foreground.g, root.foreground.b, 0.22)
                      : Qt.rgba(root.foreground.r, root.foreground.g, root.foreground.b, 0.06)
                    ...
                    MouseArea {
                      anchors.fill: parent
                      cursorShape: Qt.PointingHandCursor
                      onClicked: if (root.mouse) root.mouse.setReportRate(modelData)
                    }
                  }
                }
              }
            ...
            Column {
              ...
              Column {
                ...
                PanelSlider {
                  ...
                  onMoved: function(val) { leftActSlider.value = Math.round(val) }
                  onReleased: function(val) {
                    leftActSlider.value = Math.round(val)
                    if (root.mouse) root.mouse.setActuation(0, Math.round(val))
                  }
                }
                ...
                Item {
                  ...
                  Repeater {
                    ...
                    Text {
                      ...
                      font.pixelSize: 10
                      font.bold: isCurrent
                      x: Math.max(0, Math.min(parent.width - implicitWidth,
                                              parent.width * (index / 9) - implicitWidth / 2))
                    }
                  }
                }
              }
              ...
              Column {
                ...
                PanelSlider {
                  ...
                  onMoved: function(val) { leftRtSlider.value = Math.round(val) }
                  onReleased: function(val) {
                    leftRtSlider.value = Math.round(val)
                    if (root.mouse) root.mouse.setRapidTrigger(0, Math.round(val))
                  }
                }
              ...
              Column {
                ...
                PanelSlider {
                  ...
                  onMoved: function(val) { leftHapSlider.value = Math.round(val) }
                  onReleased: function(val) {
                    leftHapSlider.value = Math.round(val)
                    if (root.mouse) root.mouse.setHaptics(0, Math.round(val))
                  }
                }
                ...
                Item {
                  ...
                  Repeater {
                    ...
                    Text {
                      ...
                      font.bold: isCurrent
                      x: Math.max(0, Math.min(parent.width - implicitWidth,
                                              parent.width * (index / 5) - implicitWidth / 2))
                    }
                  }
                }
              }
            ...
            Column {
              ...
              Column {
                ...
                PanelSlider {
                  ...
                  onMoved: function(val) { rightActSlider.value = Math.round(val) }
                  onReleased: function(val) {
                    rightActSlider.value = Math.round(val)
                    if (root.mouse) root.mouse.setActuation(1, Math.round(val))
                  }
                }
              ...
              Column {
                ...
                PanelSlider {
                  ...
                  onMoved: function(val) { rightRtSlider.value = Math.round(val) }
                  onReleased: function(val) {
                    rightRtSlider.value = Math.round(val)
                    if (root.mouse) root.mouse.setRapidTrigger(1, Math.round(val))
                  }
                }
              ...
              Column {
                ...
                PanelSlider {
                  ...
                  onMoved: function(val) { rightHapSlider.value = Math.round(val) }
                  onReleased: function(val) {
                    rightHapSlider.value = Math.round(val)
                    if (root.mouse) root.mouse.setHaptics(1, Math.round(val))
                  }
                }
