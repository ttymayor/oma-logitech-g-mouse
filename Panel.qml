            ...
            Flickable {
                ...
                Column {
                    ...
                    Column {
                        width: parent.width
                        spacing: Style.space(12)
                        visible: root.mouseConnected && root.currentTab === "sensor"
                        ...
                        Column {
                            ...
                            // Quick Presets Buttons (5 items filling 100% width)
                            Row {
                                width: parent.width
                                spacing: Style.space(6)
                                Repeater {
                                    ...
                                    delegate: Rectangle {
                                        width: Math.floor((parent.width - Style.space(6) * 4) / 5)
                            ...
                            // Continuous DPI Slider (100 to 32,000 DPI)
                            Column {
                                width: parent.width
                                spacing: 0
                    ...
                    // ═══════════════════════════════════════════════════════════
                    // ── TAB 2: BUTTONS (LEFT & RIGHT ANALOG HITS TOGETHER)
                    // ═══════════════════════════════════════════════════════════
                    Column {
                        width: parent.width
                        spacing: Style.space(14)
                        visible: root.mouseConnected && root.currentTab === "buttons"
